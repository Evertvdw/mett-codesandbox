<template>
	<div class="mett-item-title">
		<mett-items-placeholder :items="relatedItemsToItems(item.relatedItems)" />
	</div>
</template>
...
@Component
export default class ListItemTitle extends mixins(ItemContainer) {
